        ...
        <div>
            {_.isNull(filterWorOrder) == false ? (
                ...
                >
                    ...
                    >
                        <ChartWo
                            data={{ filterData: filterWorOrder['Sutaryo'] }}
                        />
                    </motion.div>
                </motion.div>
            ) : (
...
export default MnGM3SubHeaderUtility
