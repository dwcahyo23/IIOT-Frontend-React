            ...
            .mapValues((items) => {
                return {
                    breakdown: _.countBy(items, (val) =>
                        val.com_no == '03' && val.pri_no == '01'
                            ? 'pass'
                            : 'fail'
                    ),
                    still_run: _.countBy(items, (val) =>
                        val.com_no == '03' && val.pri_no == '02'
                            ? 'pass'
                            : 'fail'
                    ),
                    preventive: _.countBy(items, (val) =>
                        val.com_no == '03' && val.pri_no == '03'
                            ? 'pass'
                            : 'fail'
                    ),
                    workshop: _.countBy(items, (val) =>
                        val.com_no == '03' && val.pri_no == '04'
                            ? 'pass'
                            : 'fail'
                    ),
                    work_order: _.countBy(items, (val) =>
                        val.com_no == '03' ? 'pass' : 'fail'
                    ),
                    audit: _.countBy(items, (val) =>
                        val.com_no == '03' && val.chk_mark == 'Y'
                            ? 'pass'
                            : 'fail'
                    ),
